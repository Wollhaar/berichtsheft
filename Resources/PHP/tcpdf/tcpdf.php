...
// TCPDF configuration
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/include/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/include/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/include/tcpdf_colors.php');
// TCPDF static image methods and data
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/include/tcpdf_images.php');
// TCPDF static methods and data
require_once($_SERVER['DOCUMENT_ROOT'].'/Resources/PHP/tcpdf/include/tcpdf_static.php');
